...
export const TEAMS: TeamEntry[] = [
  ...
  { name: 'Czechia', code: 'CZE', iso: 'cz', aliases: ['Czech Republic'] },
  { name: 'Bosnia and Herzegovina', code: 'BIH', iso: 'ba', aliases: ['Bosnia'] },
  ...
  { name: 'Curacao', code: 'CUW', iso: 'cw', aliases: ['Curaçao'] },
  { name: 'New Zealand', code: 'NZL', iso: 'nz' },
  { name: 'Haiti', code: 'HAI', iso: 'ht' },
  { name: 'Jamaica', code: 'JAM', iso: 'jm' },
  { name: 'Honduras', code: 'HON', iso: 'hn' },
  { name: 'Venezuela', code: 'VEN', iso: 've' },
  { name: 'Bolivia', code: 'BOL', iso: 'bo' },
