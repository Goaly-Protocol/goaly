...
/// @notice Deploys GoalyVault wired to the Morpho "Gauntlet USDT0 Core" vault on Arbitrum One.
contract Deploy is Script {
    address internal constant MORPHO_VAULT = 0x139250CdB310D657eAC506c7C7FC6AcDE34Af1ec;

    function run() external returns (GoalyVault vault) {
        ...
        vault = new GoalyVault(IERC20(morpho.asset()), morpho);
        vm.stopBroadcast();
        console2.log("GoalyVault deployed at:", address(vault));
    }
}
